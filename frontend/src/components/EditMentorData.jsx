  ...
  return (
    <div className="w-full">
          ...
          >
            ...
            <div className="flex gap-2 mb-4">
              ...
              <button
                ...
                className="bg-gradient-to-r from-cyan-500 to-purple-600 text-white rounded-xl px-5 py-3 flex items-center justify-center gap-2 shadow-lg font-semibold hover:scale-105 transition duration-300"
              >
        ...
        <div className="space-y-10">
          ...
          >
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-cyan-500 to-purple-600 text-white rounded-xl px-5 py-3 flex items-center justify-center gap-2 shadow-lg font-semibold hover:scale-[1.02] transition duration-300 mb-4"
            >
      ...
      <div className="mt-8">
        <button
          onClick={handleSave}
          className="w-full bg-gradient-to-r from-cyan-500 to-purple-600 text-white font-bold rounded-xl px-8 py-5 shadow-xl text-lg flex items-center justify-center gap-3 hover:scale-[1.01] transition"
        >
