          ...
          {scrollToId && (
            <div className="mt-6 flex justify-center">
              <button
                ...
                className="group px-6 sm:px-8 py-3 bg-gradient-to-r from-cyan-500 to-purple-600 text-white font-semibold rounded-xl shadow-lg hover:shadow-purple-500/50 transition-all duration-300 hover:scale-105 flex items-center gap-2"
              >
